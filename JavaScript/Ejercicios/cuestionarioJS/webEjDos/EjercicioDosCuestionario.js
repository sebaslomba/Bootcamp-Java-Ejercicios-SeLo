function raizNegativa(a,b,c)
{
    ...
    const resultado = raizNegativa(a,b,c);
    document.getElementById("resultado").textContent = `el resultado de la version negativa de la ec es igual a  ${resultado}`
});
//ejemplo de uso
